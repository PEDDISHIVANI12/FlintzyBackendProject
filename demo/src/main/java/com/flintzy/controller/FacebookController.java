...
public class FacebookController {
	...
	@Value("${facebook.user-token-expiry-seconds}")
	...
	public ResponseEntity<?> postText(@RequestBody PostRequest req) throws Exception {
	...
	public void facebookLogin(@AuthenticationPrincipal OAuth2User googleUser,
		...
		String fbLoginUrl =
				"https://www.facebook.com/" + apiVersion + "/dialog/oauth?" +
						"client_id=" + appId +
						"&redirect_uri=" + redirectUri +
						"&scope=public_profile,email,pages_manage_posts,pages_read_engagement,pages_show_list"+"&state="+appUserId;
